...
const TARGETS: Record<string, string[]> = {
  ...
  // Slugs match the canonical names in the seeded DB (see `masters.slug`),
  // not the Wikipedia article titles — keep these in sync after any rename.
  ...
  "yasutani-hakuun": ["Hakuun Yasutani"],
  "nakagawa-soen": ["Soen Nakagawa"],
  ...
  "mingan-rongxi": ["Eisai", "Myōan Eisai"],
  "kanzan-egen": ["Kanzan Egen"],
  "shuho-myocho": ["Shūhō Myōchō", "Daitō Kokushi"],
  "kosho-uchiyama": ["Kōshō Uchiyama", "Kosho Uchiyama"],
  "kodo-sawaki": ["Kōdō Sawaki", "Kodo Sawaki"],
};
