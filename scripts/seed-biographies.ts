...
Warner's other principal output is on the public web: he has maintained the [Hardcore Zen](https://hardcorezen.info/) blog continuously since the early 2000s, hosts the long-running [Hardcore Zen Podcast](https://hardcorezen.podbean.com/), publishes dharma talks and Q&A sessions on his [YouTube channel](https://www.youtube.com/hardcorezen), and runs a [Patreon](https://www.patreon.com/bradwarner) that supports his ongoing teaching at Dogen Sangha Los Angeles[2]. His deliberately abrasive, demystifying style has made him one of the visible faces of contemporary American Zen.`,
    footnotes: [
      {
        index: 1,
        sourceId: "src_wikipedia",
      ...
      {
        index: 2,
        sourceId: "src_hardcorezen_blog",
        pageOrSection: "hardcorezen.info — front page and linked podcast / YouTube / Patreon profiles",
      },
    ],
  },
  {
