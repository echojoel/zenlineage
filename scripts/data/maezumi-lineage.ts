...
export const MAEZUMI_MASTERS: KVMaster[] = [
  // ─── Teachers who authorize Maezumi's triple lineage ─────────────────
  {
    ...
    footnotes: [
      { index: 1, sourceId: "src_whiteplum", pageOrSection: "whiteplumasanga.org — Founder and Dharma Heirs" },
      { index: 2, sourceId: "src_whiteplum", pageOrSection: "whiteplumasanga.org — Founder and Dharma Heirs" },
      { index: 3, sourceId: "src_whiteplum", pageOrSection: "whiteplumasanga.org — Founder and Dharma Heirs" },
    ],
    transmissions: [],
  },
  {
    ...
    footnotes: [
      { index: 1, sourceId: "src_zcla_maezumi_founders", pageOrSection: "ZCLA Water Wheel — founder history" },
      { index: 2, sourceId: "src_zcla_maezumi_founders", pageOrSection: "ZCLA Water Wheel — founder history" },
      { index: 3, sourceId: "src_zcla_maezumi_founders", pageOrSection: "ZCLA Water Wheel — founder history" },
    ],
    transmissions: [],
  },
  ...
  },
  {
    ...
    deathConfidence: "high",
    biography:
      "Nicolee Jikyo McCann (慈鏡) is a White Plum dharma heir of Taizan Maezumi teaching in Southern California. She served as a senior teacher in the Maezumi line for many years and continues teaching in the White Plum tradition[1].",
    citations: [
    ...
    transmissions: [
      {
        ...
        isPrimary: true,
        sourceIds: ["src_whiteplum"],
        notes: "Listed among Maezumi's twelve White Plum dharma heirs on the White Plum Asanga founder page.",
      },
    ],
  },
  {
    ...
    deathConfidence: "high",
    biography:
      "William Nyogen Yeo (如幻) is a White Plum dharma heir of Taizan Maezumi. Long associated with Zenshuji Soto Mission in Los Angeles, he has taught in the Maezumi line since his dharma transmission and continues as a senior teacher[1].",
    citations: [
      { sourceId: "src_whiteplum", fieldName: "biography", pageOrSection: "founder" },
    ],
    footnotes: [
    ...
    transmissions: [
      {
        ...
        isPrimary: true,
        sourceIds: ["src_whiteplum"],
        notes: "White Plum dharma heir of Maezumi long associated with Zenshuji Soto Mission in Los Angeles.",
      },
    ],
  },
  {
    ...
    biography:
      "Susan Myoyu Andersen (妙裕) was a White Plum dharma heir of Taizan Maezumi who served for many years at the Zen Center of Los Angeles. She is remembered for steady teaching in the residential sangha during and after Maezumi's lifetime[1].",
    citations: [
      { sourceId: "src_whiteplum", fieldName: "biography", pageOrSection: "founder" },
    ],
    footnotes: [
    ...
    transmissions: [
      {
        ...
        isPrimary: true,
        sourceIds: ["src_whiteplum"],
        notes: "Among Maezumi's twelve White Plum heirs; served for years at the Zen Center of Los Angeles.",
      },
    ],
  },
  {
    ...
    deathConfidence: "low",
    biography:
      "John Tesshin Sanderson (徹心) is a White Plum dharma heir of Taizan Maezumi, one of the twelve senior students Maezumi authorized before his death in 1995[1].",
    citations: [
      { sourceId: "src_whiteplum", fieldName: "biography", pageOrSection: "founder" },
    ],
    footnotes: [
    ...
    transmissions: [
      {
        ...
        isPrimary: true,
        sourceIds: ["src_whiteplum"],
        notes: "One of the twelve senior students Maezumi authorized as dharma heirs before his death in 1995.",
      },
    ],
  },
  {
    ...
    deathConfidence: "low",
    biography:
      "Alfred Jitsudo Ancheta (実道) is a White Plum dharma heir of Taizan Maezumi, authorized among the cohort of senior students who received transmission before Maezumi's death. He teaches in Southern California in the Maezumi line[1].",
    citations: [
      { sourceId: "src_whiteplum", fieldName: "biography", pageOrSection: "founder" },
    ],
    footnotes: [
  ...
  },
  {
    ...
    deathConfidence: "high",
    biography:
      "Anne Seisen Saunders (正泉) is a White Plum dharma heir of Taizan Maezumi and abbot of Sweetwater Zen Center in National City, California, which she founded as a residential training community. She continues to teach actively in the Maezumi line[1].",
    citations: [
      { sourceId: "src_whiteplum", fieldName: "biography", pageOrSection: "founder" },
    ],
    footnotes: [
    ...
    transmissions: [
      {
        ...
        isPrimary: true,
        sourceIds: ["src_whiteplum"],
        notes: "White Plum dharma heir of Maezumi and founding abbot of Sweetwater Zen Center (National City, CA).",
      },
    ],
  },
];
