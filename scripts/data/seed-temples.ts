...
export const SEED_TEMPLES: TempleSeed[] = [
  ...
  },
  {
    ...
    lat: 50.8738,
    lng: 7.5990,
    region: "Waldbröl, North Rhine-Westphalia",
    country: "Germany",
    foundedYear: 2008,
    foundedPrecision: "exact",
    schoolSlug: "plum-village",
  ...
  },
  {
    ...
    lat: 35.4875,
    lng: 129.0664,
    region: "Yangsan, South Gyeongsang",
    country: "South Korea",
    foundedYear: 646,
    foundedPrecision: "exact",
    schoolSlug: "jogye",
  ...
  // ─── Kwan Um School in the West ──────────────────────────────────────
  {
    ...
    lat: 41.9709,
    lng: -71.4370,
    region: "Cumberland, Rhode Island",
    country: "United States",
    foundedYear: 1972,
    foundedPrecision: "exact",
    schoolSlug: "kwan-um",
  ...
  },
  {
    ...
    lat: 45.0200,
    lng: 4.4158,
    region: "Saint-Laurent-du-Pape, Ardèche",
    country: "France",
    foundedYear: 1974,
    foundedPrecision: "exact",
    schoolSlug: "rinzai",
  ...
  // ─── European Sōtō Zen — Italy ───────────────────────────────────────
  {
    ...
    lat: 44.8169,
    lng: 9.9878,
    region: "Bargone di Salsomaggiore, Emilia-Romagna",
    country: "Italy",
    foundedYear: 1983,
    foundedPrecision: "exact",
    schoolSlug: "soto",
  ...
  // ─── Plum Village monastic practice centres (global) ─────────────────
  {
    ...
    lat: 48.8729,
    lng: 3.2803,
    region: "Verdelot, Seine-et-Marne",
    country: "France",
    foundedYear: 2008,
    foundedPrecision: "circa",
    schoolSlug: "plum-village",
  ...
  },
  {
    ...
    lat: 48.8239,
    lng: 3.2741,
    region: "Villeneuve-sur-Bellot, Seine-et-Marne",
    country: "France",
    foundedYear: null,
    foundedPrecision: null,
    schoolSlug: "plum-village",
  ...
  },
  {
    ...
    lat: 22.2580,
    lng: 113.9060,
    region: "Ngong Ping, Lantau Island",
    country: "Hong Kong",
    foundedYear: null,
    foundedPrecision: null,
    schoolSlug: "plum-village",
  ...
  },
  {
    ...
    lat: 14.7050,
    lng: 101.4500,
    region: "Pak Chong District, Nakhon Ratchasima",
    country: "Thailand",
    foundedYear: 2008,
    foundedPrecision: "exact",
    schoolSlug: "plum-village",
  ...
  },
  {
    ...
    lat: -37.3667,
    lng: 143.4500,
    region: "Porcupine Ridge, Victoria",
    country: "Australia",
    foundedYear: 2010,
    foundedPrecision: "exact",
    schoolSlug: "plum-village",
  ...
  // ─── Order of Buddhist Contemplatives (Kennett lineage, Sōtō-derived)
  {
    ...
    lat: 41.3099,
    lng: -122.3106,
    region: "Mount Shasta, California",
    country: "United States",
    foundedYear: 1970,
    foundedPrecision: "exact",
    schoolSlug: "soto",
  ...
  // ─── One Drop Zen (Shōdō Harada Rōshi's global sangha) ───────────────
  {
    ...
    lat: 48.2530,
    lng: -122.5833,
    region: "Whidbey Island, Washington",
    country: "United States",
    foundedYear: 1999,
    foundedPrecision: "circa",
    schoolSlug: "rinzai",
