...
export const EUROPE_TEMPLE_SEEDS: TempleSeed[] = [
  ...
  {
    slug: "kokaiji-zen-temple-vannes",
    names: [
      { locale: "fr", value: "Temple zen Kokaiji" },
      { locale: "en", value: "Kokaiji Zen Temple" },
    ],
    lat: 47.6559,
    lng: -2.7603,
    region: "Vannes, Morbihan, Bretagne",
    country: "France",
    foundedYear: null,
    foundedPrecision: null,
    schoolSlug: "soto",
    status: "active",
    sourceId: "src_sotozen_europe",
    sourceExcerpt: "Kokaiji (Temple of the Ancient Ocean) — Sōtō Zen temple in Vannes near the Gulf of Morbihan, offering zazen, ceremonies and Dharma teaching under Rev. Pierre Dokan Crépon; listed in the Sōtōshū-recognized European Sōtō Zen temple directory.",
    url: "https://templezen-kokaiji.org/",
  },
  {
    slug: "demeure-sans-limites-saint-agreve",
    names: [
      { locale: "fr", value: "La Demeure sans Limites" },
      { locale: "en", value: "The Place of No Limits Zen Temple" },
    ],
    lat: 45.0108,
    lng: 4.3969,
    region: "Saint-Agrève, Ardèche, Auvergne-Rhône-Alpes",
    country: "France",
    foundedYear: 1991,
    ...
    status: "active",
    sourceId: "src_eu_zen_research",
    sourceExcerpt: "La Demeure sans Limites — Sōtō Zen Buddhist temple in Saint-Agrève, Ardèche, founded in 1991 by nun Joshin Luce Bachoux at the request of her teacher Moriyama; now hosted and guided by Jôkei Sensei Lambert, offering retreats and daily zazen.",
    url: "https://www.larbredeleveil.org/lademeuresanslimites/",
  },
  {
    slug: "yujo-nyusanji-caroux",
    names: [
      { locale: "en", value: "Yujo Nyusanji Zen Temple (Caroux)" },
      { locale: "fr", value: "Temple zen du Caroux – Yujo Nyusanji" },
    ],
    lat: 43.6678,
    lng: 3.0047,
    region: "Rosis, Hérault, Occitanie",
    country: "France",
    foundedYear: 2009,
    foundedPrecision: "exact",
    schoolSlug: "soto",
    status: "active",
    sourceId: "src_kosen_sangha",
    sourceExcerpt: "Yujo Nyusanji is located in France in the Occitanie region, 60 km north of Béziers, on the border of the Hérault, Tarn, and Aveyron departments. Founded by Master Kosen in 2009 to provide a permanent living and meeting center for his European sangha, dedicated to the practice and teaching of zazen.",
    url: "https://www.zen-temple.earth/",
  },
  {
    slug: "horin-ji-lanau",
    names: [
      { locale: "fr", value: "Temple Zen Hôrin Ji (Centre zen de Lanau)" },
      { locale: "en", value: "Hôrin Ji Zen Temple, Lanau" },
    ],
    lat: 44.8925,
    lng: 2.9985,
    region: "Lanau, Neuvéglise-sur-Truyère, Cantal, Auvergne-Rhône-Alpes",
    country: "France",
    foundedYear: null,
    foundedPrecision: null,
    schoolSlug: "soto",
    status: "active",
    sourceId: "src_azi",
    sourceExcerpt: "Temple Zen Hôrin Ji — listed in the Association Zen Internationale directory as a Sōtō temple at Neuvéglise (15260), responsable Guy Mokuhō Mercier; communal living place whose basis is zazen and Buddhist ethics on the banks of the Truyère.",
    url: "https://www.centrezenlanau.org/",
  },
  {
    slug: "dojo-zen-de-lille",
    names: [
      { locale: "fr", value: "Dojo Zen de Lille" },
      { locale: "en", value: "Lille Zen Dojo" },
    ],
    lat: 50.633,
    lng: 3.0586,
    ...
    status: "active",
    sourceId: "src_azi",
    sourceExcerpt: "Dojo Zen de Lille, 69 rue Coustou, 59000 Lille — listed in the AZI directory; place dedicated to zazen where Sōtō Zen is transmitted in the tradition of Kōdō Sawaki and Taisen Deshimaru, with regular early-morning and evening sessions.",
    url: "https://www.zenlille.org/",
  },
  {
  ...
  },
  {
    ...
    status: "historical",
    sourceId: "src_eu_zen_research",
    sourceExcerpt: "Zen Rotterdam (Kloostertuin / Maha Karuna Ch'an) — listed at mahakarunachan.nl (Maha Karuna Ch'an (Lathouwers)). In-person Kloostertuin sit closed 2025; org continues online and through branch groups.",
  ...
  {
    slug: "zen-river-temple-uithuizen",
    names: [
    ...
    status: "active",
    sourceId: "src_sotozen_europe",
    sourceExcerpt: "Zen River, Zensenji — Oldörpsterweg 3, 9981 NL, Uithuizen, THE NETHERLANDS — Rev. Tenkei Coppens and Rev. Myoho Gabrysch. Self-identifies as 'White Plum Lineage and the Soto School'; registered in Japan as a Tokubetsu Jiin (international missionary temple of Sōtōshū).",
    url: "https://www.zenrivertemple.org/",
  },
  {
    slug: "dharmahuis-leeuwarden",
    names: [{ locale: "nl", value: "Dharmahuis Leeuwarden" }],
    lat: 53.2014,
    lng: 5.7997,
    region: "Friesland",
    country: "Netherlands",
    ...
    status: "active",
    sourceId: "src_bun",
    sourceExcerpt: "Dharmahuis, Tuinen 15, 8911KB Leeuwarden — Friesland branch of the International Zen Institute Netherlands, affiliated with Noorder Poort (Gesshin Prabhasa Dharma → Jiun Hogen Roshi line).",
    url: "https://www.dharmahuis.nl/",
  },
  {
    slug: "maha-karuna-chan-nl",
    names: [{ locale: "nl", value: "Maha Karuna Ch'an" }],
    lat: 51.9404,
    lng: 4.4944,
    region: "Zuid-Holland",
    country: "Netherlands",
    ...
    status: "active",
    sourceId: "src_bun",
    sourceExcerpt: "MKC is rooted in the Chinese Ch'an tradition of Lin Chi (Rinzai in Japanese). Teh Cheng, patriarch of the lineage, gave Ton Lathouwers transmission in 1987. Prins Bernhardkade 24A, Rotterdam. Founder Ton Lathouwers (1932–2024); Hanneke de Caluwé carries current transmission.",
    url: "https://mahakarunachan.nl/",
  },
  {
    slug: "rotterdamse-sangha",
    names: [{ locale: "nl", value: "Rotterdamse Sangha" }],
    lat: 51.9436,
    lng: 4.4847,
    region: "Zuid-Holland",
    country: "Netherlands",
    ...
    status: "active",
    sourceId: "src_plumvillage_monastic",
    sourceExcerpt: "Rotterdamse Sangha — lay-led Plum Village / Thich Nhat Hanh tradition meeting biweekly at Zonneoog, Bergsingel 122, 3037 GM Rotterdam.",
    url: "https://www.rotterdamsesangha.nl/",
  },
  {
    slug: "leven-in-aandacht-nl",
    names: [
      { locale: "nl", value: "Stichting Leven in Aandacht" },
      { locale: "en", value: "Living in Mindfulness" },
    ],
    lat: 52.1601,
    lng: 4.4970,
    region: "Zuid-Holland",
    ...
    status: "active",
    sourceId: "src_plumvillage_monastic",
    sourceExcerpt: "Zen tradition inspired by zenmeester en vredesactivist Thich Nhat Hanh. Founded in 1995, Leven in Aandacht is the Dutch-Flemish Plum Village foundation with ~75 local meditation groups across the Netherlands and Belgium. Registered office Dobbedreef 171, 2331 SB Leiden.",
    url: "https://www.aandacht.net/",
  },
  {
    slug: "wake-up-nederland",
    names: [{ locale: "en", value: "Wake Up Nederland" }],
    lat: 52.1601,
    lng: 4.4970,
    region: "Zuid-Holland",
    country: "Netherlands",
    ...
    status: "active",
    sourceId: "src_plumvillage_monastic",
    sourceExcerpt: "Wake Up Amsterdam, Wake Up Utrecht, Wake Up Rotterdam, Wake Up Nijmegen — Plum Village young-adult (18–35) network, sister programme of Leven in Aandacht.",
    url: "https://www.wkup.nl/",
  },
  {
