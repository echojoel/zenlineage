...
export const EUROPE_TEMPLE_SEEDS: TempleSeed[] = [
  ...
  },
  {
    ...
    status: "active",
    sourceId: "src_sotozen_jp",
    sourceExcerpt: "Monastero Zen Enso-ji Il Cerchio — listed at www.sotozen.com (White Plum Asanga (Maezumi lineage)). Sōtōshū-registered as Ensoji. Founder/abbot Carlo Tetsugen Serra. UBI member.",
