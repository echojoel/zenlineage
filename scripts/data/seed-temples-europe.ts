...
export const EUROPE_TEMPLE_SEEDS: TempleSeed[] = [
  ...
  },
  {
    ...
    status: "active",
    sourceId: "src_ubp",
    sourceExcerpt: "Sangha Zen Flor Silvestre — Lisboa (Wild Flower Zen) — listed at uniaobudista.pt (White Plum Asanga (Maezumi lineage)). Portuguese branch (founded 2012) of Wild Flower Zen Sangha (France, 2004). Spiritual director: Amy Hollowell Roshi. UBP member; weekly practice currently online plus three annual in-person retreats in Portugal.",
