...
export const SANBO_ZEN_MASTERS: KVMaster[] = [
  // ─── European Christian-Zen pioneer ──────────────────────────────────
  {
    ...
    footnotes: [
      { index: 1, sourceId: "src_wikipedia", pageOrSection: "en.wikipedia.org — Hugo Enomiya-Lassalle", excerpt: "Hugo Makibi Enomiya-Lassalle (11 November 1898 – 7 July 1990) was a German Jesuit priest who lived in Japan from 1929, survived the Hiroshima atomic bombing in 1945, and was an important figure in Christian-Zen dialogue. Born at Gut Externbrock near Nieheim, Westphalia; died at Münster, Westphalia. Trained under Harada Daiun Sogaku, Yasutani Hakuun, and Yamada Kōun at the San-un Zendō in Kamakura; authorised as a Zen teacher within the Sanbō Kyōdan. Books include 'Zen — Way to Enlightenment' (1968) and 'Zen Meditation for Christians' (1974)." },
