...
sources:
  ...
  - publisher: "Academia.edu — Dahui Zonggao and Zhang Shangying in the Late Northern Song Dynasty"
    url: https://www.academia.edu/8570942/Dahui_Zonggao_and_Zhang_Shangying_in_the_late_Northern_Song_dynasty
    domain_class: academic
    retrieved_on: "2026-05-15"
    quote: |
      Dahong Zuzheng broadened his education with the Dharma-heirs of Huanglong Huinan, suggesting his training and affiliation was with the Huanglong branch during this period rather than direct one-step transmission from Huanglong Huinan himself.
  - publisher: "Wisdomlib / lineage synthesis — Xu Chuandeng Lu"
    url: https://www.wisdomlib.org/definition/huang-long
    domain_class: reference
    retrieved_on: "2026-05-15"
    quote: |
...
reducer_notes: |
  ...
  as a direct dharma heir of Huanglong Huinan (d. 1069). If Dahong is 23rd-generation,
  he would be several generations removed from Huinan's direct students. The edge may
  represent school affiliation rather than direct one-step transmission. Tier C retained.
  Human review recommended with Wudeng Huiyuan or Jiatai Pudenglu primary sources.
