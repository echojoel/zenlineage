...
reducer_notes: |
  ...
  school heir (via Bajiao), not a direct heir of Guishan. The edge guishan-lingyou -> xingyang-qingrang
  may be incorrect (should be guishan → yangshan → bajiao → xingyang). Flagged for human review.
human_review_needed: true
---

Xingyang Qingrang is documented as a dharma heir of Bajiao Huiqing (himself in the Guiyang lineage),
not a direct heir of Guishan Lingyou. The transmission edge as stated may represent a lineage
shortcut or error in attribution.
