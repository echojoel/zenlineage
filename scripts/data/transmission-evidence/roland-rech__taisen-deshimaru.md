...
sources:
  ...
  - publisher: "Roland Yuno Rech, Zen Master — Zen Kannon Barcelona"
    url: https://zenkannon.org/en/roland-yuno-rech/
    domain_class: sangha
    retrieved_on: 2026-05-15
    quote: |
      In 1984, Roland Yuno Rech, along with Stéphane Kosen Thibaut and Etienne Mokusho Zeisler, all close disciples of Taisen Deshimaru, received the Dharma transmission (Shiho) in the Soto Zen tradition from Master Niwa Rempo Zenji, thus recognizing Taisen Deshimaru's mission in Europe.
  - publisher: "Maître Taisen Deshimaru — Association Zen Internationale"
...
reducer_notes: |
  ...
  institutional + reference + sangha, ≥2 independent hosts.
