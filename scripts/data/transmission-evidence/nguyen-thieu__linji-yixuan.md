...
sources:
  - publisher: "Wikipedia — Buddhism in Vietnam"
    ...
    quote: |
      In the 17th century, a group of Chinese monks led by Nguyên Thiều established a vigorous
      new school, the Lâm Tế, based on the Linji school, which mixed Chan and Pure Land Buddhism.
  - publisher: "Parallax Press — A Special Section: Buddhism in Vietnam"
    url: https://www.parallax.org/mindfulnessbell/article/a-special-section-buddhism-in-vietnam/
    domain_class: sangha
    retrieved_on: 2026-05-15
    quote: |
...
Nguyên Thiều (1648-1728) brought the Linji (Lâm Tế) school from China to Vietnam in 1665,
founding the Nguyên-Thiêu school. His lineage traces back to Linji Yixuan through approximately
30+ generations. This edge represents school-founder lineage affiliation.
