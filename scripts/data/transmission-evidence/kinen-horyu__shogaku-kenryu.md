...
sources:
  - publisher: "Athens Zen Center — Lineage list (zencenterathens.com)"
    ...
    quote: |
      Shōgaku Kenryū (?–1485) … Kinen Hōryū (?–1506) — listed in direct
      sequential order in the Hosshin-ji Sōtō Zen lineage.
  - publisher: "ZENKAN — Lineage of Soto Zen (zenkan.com)"
    url: https://zenkan.com/en/lineage/
    domain_class: community
    retrieved_on: "2026-05-15"
    quote: |
      Shogaku Kenryu and Kinen Horyu appear consecutively in the unbroken
      dharma transmission line descending from Eihei Dogen, following the
