...
sources:
  - publisher: "Terebess — Myōan Eisai"
    ...
    quote: |
      ...
      (Rinzai) Zen with the Huanglong (Oryo) 黄龍 lineage master Xuan
      Huaichang (虛庵 懷敞, c.1125-1195). The lineage chart shows Huanglong
      Huinan (黃龍 慧南, 1002-1069) as the 18th ancestor, positioned several
  ...
  - publisher: "Terebess — Huanglong Huinan"
    ...
    quote: |
      ...
      by MYŌAN EISAI (1141–1215), who studied with the eighth-generation
      Huanglong teacher Xu'an Huaichang. Xu'an Huaichang (c.1125-1195) is
      identified as an eighth-generation Huanglong teacher.
  - publisher: "Encyclopedia of Buddhism — Eisai"
    url: https://encyclopediaofbuddhism.org/wiki/Eisai
    domain_class: academic
    retrieved_on: "2026-05-15"
    quote: |
      Eisai returned in 1187 for a longer stay as a disciple of Xuan
      Huaichang, a master in the Linji (Rinzai) line, at Jingde Si monastery.
...
Myoan Eisai (1141–1215) received direct dharma transmission from Xu'an Huaichang (c.1125–1195), the 8th-generation Huanglong teacher — not from Huanglong Huinan (d. 1069) directly. Three sources confirm this lineage chain. The edge myoan-eisai → huanglong-huinan represents school affiliation (Eisai introduced the Huanglong line to Japan) rather than direct one-step transmission. Tier C. Edge semantics should be reviewed.
