...
sources:
  - publisher: "Terebess Asia Online — Sōtō Zen lineage chain (terebess.hu)"
    ...
    quote: |
      Tokuō Ryōkō … Hōgen Sōren … Sekisō Tesshū … Ryūkō Ryōshū …
      Renzan Sōhō … Motsugai … Shidō — lineage chain confirmed on
      the Kōdō Sawaki lineage page.
  ...
  - publisher: "Nossacasa.net — Shunya (Ryuko Ryoshu dharma biography)"
    url: http://www.nossacasa.net/shunya/ryuko-ryoshu/
    domain_class: reference
    retrieved_on: "2026-05-15"
    quote: |
...
reducer_notes: |
  ...
  would need a Sōtōshū headquarters source (sotozen.com, eiheiji.jp, sojiji.jp) explicitly
  naming this pair.
