...
reducer_notes: |
  ...
  The edge goto-zuigan->morinaga-soko may represent an indirect or lineage-chart relationship
  rather than a direct inka transmission. Tier C because one credible source (Wikipedia) confirms
  training under Goto but not direct inka from him. Human review recommended to clarify whether
  the database edge refers to initial ordination/training or formal inka.
