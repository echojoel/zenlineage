...
sources:
  - publisher: "ZENKAN lineage listing — Deshimaru ancestral chain (zenkan.com)"
    ...
    quote: |
      Entry 29 lists Shoryu Koho followed immediately by entry 30 Shokoku
      Zenko in the Japan section of the Soto Zen transmission chain.
  - publisher: "Soto Zen Buddhist Community — Epilogue on Kodo Sawaki (sotozen.es)"
    url: https://sotozen.es/en/zendodigital/tradicion/50-epilogo/
    domain_class: institutional
    retrieved_on: "2026-05-15"
    quote: |
      Sawaki fue ordenado por Sawada Koho, el abad de Soshinji, en el lejano
      Kyushu — confirming Sawada Koho (= Shoryu Koho) as abbot of Soshinji
      and ordination master of Kodo Sawaki.
