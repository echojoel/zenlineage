...
sources:
  ...
  - publisher: "PeoplePill — Renpō Niwa biography"
    url: https://peoplepill.com/i/rempo-niwa-zenji
    domain_class: reference
    retrieved_on: 2026-05-22
    quote: |
      His dharma heirs include Gudō Wafu Nishijima and Moriyama Daigyo as well as several teachers affiliated with the Taisen Deshimaru Lineage in Europe. Zenji (literally, "Zen Master") is an honorary title given to the senior Eihei temple (Eihei-ji), headquarters of the Sōtō school, founded in the thirteenth century by Master Dogen.
  - publisher: "Treeleaf Zendo — Dharma transmission from Nishijima Roshi (forum)"
...
reducer_notes: |
  ...
  explicitly documents that Moriyama received transmission from TWO teachers:
  (1) Noiri rōshi (Hakusan Kōjun) as primary, and (2) Niwa Zenji (Zuigaku
  Rempō) as second. The Wikipedia Rempo Niwa article independently lists
  Moriyama Daigyo among his dharma heirs.

  A French-language Wikipedia article (fr.wikipedia.org/wiki/Niwa_Zenji)
  also corroborates: "Il fut également le maître de Gudo Nishijima et de
