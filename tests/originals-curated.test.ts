...
describe("originals-curated overlay", () => {
  ...
  it("contains high-confidence downstream branch spines", () => {
    ...
    expect(teacherByName.get("Jingzhong Wuxiang")).toBe("Zizhou Chuji");
    ...
    expect(teacherByName.get("Baling Haojian")).toBe("Yunmen Wenyan");
    ...
    expect(teacherByName.get("Doushuai Congyue")).toBe("Baofeng Kewen");
    expect(teacherByName.get("Taiping Huiqin")).toBe("Wuzu Fayan");
    expect(teacherByName.get("Huguo Jingyuan")).toBe("Yuanwu Keqin");
    ...
    expect(teacherByName.get("Zhuan Shigui")).toBe("Foyan Qingyuan");
    expect(teacherByName.get("Poan Zuxian")).toBe("Mian Xianjie");
    expect(teacherByName.get("Wuzhun Shifan")).toBe("Poan Zuxian");
    // Yuelin Shiguan is intentionally orphaned upstream: his teacher
    // (Lao'na Zudeng) is not in the dataset, and the old Wuzhun Shifan
    // edge was chronologically impossible (Wuzhun was 35 years younger).
    expect(teacherByName.get("Yuelin Shiguan")).toBe(null);
    ...
    expect(teacherByName.get("Dayu Shouzhi")).toBe("Fenyang Shanzhao");
    expect(teacherByName.get("Qinglin Shiqian")).toBe("Dongshan Liangjie");
    ...
    expect(teacherByName.get("Baoen Xuanze")).toBe("Fayan Wenyi");
    expect(teacherByName.get("Luoshan Daoxian")).toBe("Yantou Quanhuo");
    expect(teacherByName.get("Mingzhao Deqian")).toBe("Luoshan Daoxian");
    expect(teacherByName.get("Qingxi Hongjin")).toBe("Luohan Guichen");
    expect(teacherByName.get("Tianping Congyi")).toBe("Qingxi Hongjin");
    ...
    expect(teacherByName.get("Nanta Guangyong")).toBe("Yangshan Huiji");
    expect(teacherByName.get("Jingzhao Mihu")).toBe("Guishan Lingyou");
    expect(teacherByName.get("Guannan Daochang")).toBe("Baizhang Huaihai");
    expect(teacherByName.get("Xingyang Qingrang")).toBe("Bajiao Huiqing");
    expect(teacherByName.get("Wufeng Changguan")).toBe("Baizhang Huaihai");
    expect(teacherByName.get("Xiyuan Siming")).toBe("Baoshou Yanzhao");
    expect(teacherByName.get("Huguo Shoucheng")).toBe(null);
    expect(teacherByName.get("Baofeng Weizhao")).toBe("Furong Daokai");
    expect(teacherByName.get("Kaifu Daoning")).toBe("Wuzu Fayan");
    expect(teacherByName.get("Yuean Shanguo")).toBe("Kaifu Daoning");
    expect(teacherByName.get("Dahong Zuzheng")).toBe("Xuedou Zhijian");
    ...
    expect(teacherByName.get("Baoning Renyong")).toBe("Yangqi Fanghui");
    ...
    expect(teacherByName.get("Taiyuan Fu")).toBe("Xuefeng Yicun");
    expect(teacherByName.get("Changshui Zixuan")).toBe("Langye Huijue");
    expect(teacherByName.get("Dagui Muzhe")).toBe("Changshui Zixuan");
    expect(teacherByName.get("Bajiao Huiqing")).toBe("Nanta Guangyong");
    expect(teacherByName.get("Shexian Guixing")).toBe("Fushan Fayuan");
    expect(teacherByName.get("Deshan Yuanmi")).toBe("Yunmen Wenyan");
    expect(teacherByName.get("Guizong Cezhen")).toBe("Fayan Wenyi");
    expect(teacherByName.get("Wang Yanbin")).toBe(null);
    expect(teacherByName.get("Daguang Juhui")).toBe("Shishuang Qingzhu");
    ...
    expect(teacherByName.get("Gaoan Dayu")).toBe("Guizong Zhichang");
    expect(teacherByName.get("Jiufeng Qin")).toBe(null);
    ...
    expect(teacherByName.get("Sixin Wuxin")).toBe("Huitang Zuxin");
    ...
    expect(teacherByName.get("Baizhang Niepan")).toBe("Mazu Daoyi");
    ...
    expect(teacherByName.get("Longji Shaoxiu")).toBe("Luohan Guichen");
    expect(teacherByName.get("Fengxian Daochen")).toBe("Yunmen Wenyan");
    expect(teacherByName.get("Ruiyan Shiyan")).toBe("Yantou Quanhuo");
    expect(teacherByName.get("Wenshu Yingzhen")).toBe(null);
    expect(teacherByName.get("Changfu Zhi")).toBe(null);
    ...
    expect(teacherByName.get("Chengtian Chuanzong")).toBe("Baoen Xuanze");
    expect(teacherByName.get("Dingzhou Shizang")).toBe(null);
    expect(teacherByName.get("Danyuan Yingzhen")).toBe("Nanyang Huizhong");
    ...
    expect(teacherByName.get("Lianhua Fengxiang")).toBe("Fengxian Daochen");
    expect(teacherByName.get("Zhenjing Kewen")).toBe("Huanglong Huinan");
    expect(teacherByName.get("Xutang Zhiyu")).toBe(null);
    expect(teacherByName.get("Baotang Wuzhu")).toBe("Jingzhong Wuxiang");
    // Nanyue Daoxuan was orphaned upstream in the correction pass; the
    // Shitou edge did not survive verification.
    expect(teacherByName.get("Nanyue Daoxuan")).toBe(null);
    expect(teacherByName.get("Ji'an Xin")).toBe(null);
