...
const SCHOOL_DEFINITIONS: SchoolDefinition[] = [
  ...
  },
  {
    ...
    nativeNames: { ja: "白梅" },
    summary:
      "The White Plum Asanga (白梅, 'white plum blossom') is the lineage sangha of Taizan Maezumi Roshi (1931–1995) and his Dharma successors[1]. It is not a Japanese Sōtōshū-registered sub-school but a Western Zen order that inherits Maezumi's tri-lineage authorization: Sōtō shihō from his father Baian Hakujun Kuroda, Rinzai inka from the lay teacher Kōryū Osaka, and Sanbō-Zen inka from Hakuun Yasutani[1]. Maezumi named twelve American Dharma heirs — including Bernie Tetsugen Glassman, Charlotte Joko Beck, Dennis Genpo Merzel, John Daido Loori, Jan Chozen Bays, and Gerry Shishin Wick — and through their own transmissions the White Plum now spans several hundred authorized teachers and dozens of affiliated practice places worldwide[2]. Because the order combines shikantaza with the Harada-Yasutani koan curriculum[3], and because it operates outside Sōtōshū registration, most White Plum heirs teach under the Asanga's own name rather than as Sōtō priests.",
    practice:
      "White Plum practice reflects Maezumi's triple authorization: shikantaza in the Sōtō sense (zazen as the direct expression of awakening) combined with a formal koan curriculum derived from Harada Daiun Sogaku and Hakuun Yasutani — beginning with the Mu koan, moving through breakthrough koans, and continuing into the Shōyōroku, Mumonkan, Denkōroku, and Hekiganroku[3]. Formal face-to-face interview (dokusan) is central. Many White Plum centers also integrate the social-action emphasis of the Zen Peacemaker Order, which Glassman founded in 1996 within Maezumi's line[4].",
    footnotes: [
      {
        index: 1,
        sourceTitle: "White Plum Asanga — Founder (Hakuyū Taizan Maezumi Roshi)",
        sourceUrl: "https://whiteplum.org/founder/",
        author: "White Plum Asanga",
      },
      {
        index: 2,
        sourceTitle: "White Plum Asanga — Successors and member directory",
        sourceUrl: "https://whiteplum.org/successors/",
        author: "White Plum Asanga",
      },
      {
        index: 3,
        sourceTitle: "Hakuyu Taizan Maezumi — Wikipedia",
        sourceUrl: "https://en.wikipedia.org/wiki/Hakuyu_Taizan_Maezumi",
      },
      {
        index: 4,
        sourceTitle: "Zen Peacemakers — History",
        sourceUrl: "https://zenpeacemakers.org/history/",
  ...
  },
  {
    ...
    summary:
      "The Kwan Um School of Zen is an international Seon organization founded in 1983 by the Korean master Seung Sahn (1927–2004), among the first Korean Zen teachers to establish a major presence in the West[1]. The school's name refers to Gwaneum (Avalokiteshvara), the bodhisattva of compassion[1]. Seung Sahn's teaching style combined the rigor of traditional Korean hwadu practice with a direct, humorous, and accessible approach adapted for Western students[2]. His kong-an (koan) interviews, often pivoting on the question 'What is this?', became the school's hallmark[3]. The Kwan Um School maintains over a hundred Zen centers and groups across North America, Europe, Asia, and Africa[1], making it one of the most geographically widespread Zen organizations in the world.",
    practice:
    ...
    footnotes: [
      ...
      {
        index: 2,
        sourceTitle: "Seungsahn — Wikipedia",
      ...
      },
      {
        ...
        pageOrSection: "Introduction; 'Don't-know mind' and kong-an practice",
      },
    ],
    keyTexts: [
      {
