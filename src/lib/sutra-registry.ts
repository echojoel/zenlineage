    ...
    translations: [
      {
        ...
        language: "en",
        langLabel: "EN",
        audioUrl: "/audio/sutras/heart-sutra-en-librivox.mp3",
        audioSourceUrl:
          "https://archive.org/details/diamond_sutra_and_heart_sutra_2301_librivox",
        audioAttribution:
          "LibriVox audiobook — public-domain English Heart Sūtra reading (4:55, Geoffrey Edwards)",
      },
      {
  ...
  },
  {
    ...
    translations: [
      ...
      },
      {
        ...
        langLabel: "EN",
        coverage: { kind: "selections", sections: "§§ 1, 5, 10, 26, 32 of 32" },
        audioUrl: "/audio/sutras/diamond-sutra-en-librivox.mp3",
        audioSourceUrl:
          "https://archive.org/details/diamondsutra_2312_librivox",
        audioAttribution:
          "LibriVox audiobook — opening of Gemmell's Diamond Sūtra, chapters 1–4 (6:41)",
      },
      {
    ...
    translations: [
      {
        ...
        audioUrl: "/audio/sutras/lotus-sutra-universal-gate-en-librivox.mp3",
        audioSourceUrl:
